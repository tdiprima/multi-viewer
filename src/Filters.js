class Filters {
  constructor () {
    ...
    function _setColors() {
      ...
      // Colors per layer
      this.colors.push(new filterColors(0, 255, 0)) // we skip the first layer, so colors[0] doesn't count
      this.colors.push(new filterColors(0, 255, 0)) // lime 00ff00
      this.colors.push(new filterColors(255, 255, 0)) // yellow ffff00
      this.colors.push(new filterColors(0, 255, 255)) // cyan 00ffff
      this.colors.push(new filterColors(255, 0, 0)) // red ff0000
      this.colors.push(new filterColors(255, 165, 0)) // orange ffa500
      this.colors.push(new filterColors(0, 128, 0)) // dark green 008000
      this.colors.push(new filterColors(0, 0, 255)) // blue 0000ff
      this.colors.push(new filterColors(75, 0, 130)) // indigo 4b0082
      this.colors.push(new filterColors(28, 28, 28)) // dark gray #1c1c1c
      this.colors.push(new filterColors(167, 226, 46)) // leaf green #a7e22e
      this.colors.push(new filterColors(31, 120, 180)) // strong blue, #1f78b4
      this.colors.push(new filterColors(255, 210, 4)) // goldenrod #ffd204
    }
    ...
    function setViewerFilter(viewer) {
      try {
        viewer.setFilterOptions({
          filters: [{
            items: viewer.world.getItemAt(this.layerNumber === 0 ? 1 : this.layerNumber),
            processors: [
