...
colorFilter.prototype.COLORLEVELS = layerColors => {
  return (context, callback) => {
    ...
    if (outlineFlag) {
      console.log('%coutlineFlag', 'color: deeppink;')
      ...
      console.log('%celse', 'color: deeppink;')
      const pxl = imageData
      ...
      if (renderType === 'byClass') {
        console.log('%cbyClass', 'color: #997fff;')
        setPix(inClass)
      }

      if (renderType === 'byProbability') {
        console.log('%cbyProbability', 'color: #997fff;')
        setPix(inRange)
      }

      if (renderType === 'byHeatmap') {
        console.log('%cbyHeatmap', 'color: #997fff;')
