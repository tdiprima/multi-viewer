...
colorFilter.prototype.COLORLEVELS = layerColors => {
  return (context, callback) => {
    ...
    if (outlineFlag) {
      console.log('%coutline', 'color: #997fff; font-size: larger;')
      ...
      if (renderType === 'byClass') {
        console.log('%cbyClass', 'color: #997fff; font-size: larger;')
        setPix(inClass)
      }

      if (renderType === 'byProbability') {
        console.log('%cbyProbability', 'color: #997fff; font-size: larger;')
        setPix(inRange)
      }

      if (renderType === 'byHeatmap') {
        console.log('%cbyHeatmap', 'color: #997fff; font-size: larger;')
