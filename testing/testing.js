...
function do_slides() {
  ...
  // Remove the object with "layerNum":1 from the second array in the main array
  // data[1] = data[1].filter(obj => obj.layerNum !== 1);
  // console.log(data);

  pageSetup('contentDiv', data, 2, 1, 2, 480, 640, {
    toolbarOn: true,
    paintbrushColor: '#0ff'
  });
