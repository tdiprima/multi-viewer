  ...
  [
    {
      ...
      colorscheme: {
        ...
        colors: [
          { name: 'Tumor', classid: 1, color: 'rgba(0, 255, 0, 255)' },
          { name: 'Background', classid: 4, color: 'rgba(0, 0, 255, 255)' },
          { name: 'Lymphocyte', classid: 3, color: 'rgba(255, 0, 0, 255)' },
          { name: 'Misc', classid: 2, color: 'rgba(255, 255, 0, 255)' },
        ],
        colorspectrum: [
          { color: 'rgba(0, 0, 255, 255)', high: 159, low: 101 },
          { color: 'rgba(0, 255, 0, 255)', high: 205, low: 160 },
          { color: 'rgba(255, 255, 0, 255)', high: 100, low: 0 },
          { color: 'rgba(255, 0, 0, 255)', high: 255, low: 206 },
        ],
        '@context': [
          {
            so: 'https://schema.org/',
    ...
    },
    {
      ...
      colorscheme: {
        ...
        colors: [
          { name: 'Tumor', classid: 1, color: 'rgba(0, 255, 0, 255)' },
          { name: 'Misc', classid: 2, color: 'rgba(255, 255, 0, 255)' },
          { name: 'Lymphocyte', classid: 3, color: 'rgba(255, 0, 255, 255)' },
          { name: 'Background', classid: 4, color: 'rgba(0, 255, 255, 255)' },
        ],
        colorspectrum: [
          { color: 'rgba(0, 255, 0, 255)', high: 205, low: 160 },
          { color: 'rgba(255, 255, 0, 255)', high: 100, low: 0 },
